...
const NavBar= ()=>{
    ...
    return(
        <div className="bg-green-800 bg-opacity-75 w-1/6 flex flex-col justify-between sticky h-2/3 top-0 px-3 rounded-3xl shadow-shadowBlack">
            <div className="pt-4">
                ...
                <nav className="px-2">
                    ...
                    <NavLink to="/profile/:name" className="block text-green-400 py-2 px-4 hover:bg-green-900">Perfil</NavLink>
