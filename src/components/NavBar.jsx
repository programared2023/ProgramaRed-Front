...
const NavBar= ()=>{
    ...
    //bg-mediumGreen w-1/6 flex flex-col justify-between sticky h-full top-0 px-3 rounded-sm shadow-shadowBlack min-w-20%
    return(
        <>
            ...
            {
                <div>
                    <HamburgerMenu isOpen={isOpen} isUserLogged={isUserLogged} userId={userId} />
                </div>
            }
            <div className=" hidden bg-mediumGreen w-1/6 lg:flex flex-col justify-between h-full px-3 rounded-sm shadow-shadowBlack min-w-20%">
                <div className="pt-4">
