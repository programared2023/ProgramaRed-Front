        ...
        <div className=" bg-mediumGreen w-1/6 flex flex-col justify-between sticky h-full top-0 px-3 rounded-sm shadow-shadowBlack min-w-20%">
            <div className="pt-4">
                ...
                <nav className="px-2 flex flex-col h-5/6 items-start justify-evenly" >
                    <NavLink to="/home" className={`py-2 px-4 hover:bg-darkGreen hover:scale-110 flex text-xl gap-3 w-full items-center transition-all rounded-3xl ${pathname === "/home" ? "text-white bg-darkGreen scale-110" : "text-blue-50" }`}>
